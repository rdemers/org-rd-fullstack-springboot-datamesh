...
#    - docker build --no-cache -t org-rd-fullstack/springboot-datamesh:unspecified .
#
# 6. The command to run the image:
#    - docker run -it -p8080:8080 -p8081:8081 org-rd-fullstack/springboot-datamesh:unspecified
#
